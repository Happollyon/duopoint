...
class Menu extends React.Component{
    ...
    render() {return(
            ...
            <Channel resetList={this.props.resetList}/>
                {this.props.channel_loading?(<div id='channel_loading'><img src={require('../imgs/Icon feather-loader.svg')}/></div>): <ChanelList delete_friendship={this.props.delete_friendship}delete_channel={this.props.delete_channel} handleClick_pvt_text={this.props.handleClick_pvt_text} handleClick={this.props.handleClick} private_text={this.props.private_text} channels={this.props.channels}/>}
